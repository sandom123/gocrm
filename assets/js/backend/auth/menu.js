        ...
        index: function () {
            ...
            Table.api.init({
                extend: {
                    ...
                    add_url: '/system/addMenu',
                    edit_url: '/system/editMenu',
                    del_url: '/system/delMenu',
                    dragsort_url: 'ajax/menuWeigh',
        ...
        api: {
            formatter: {
                ...
                menu: function (value, row, index) {
                    return "<a href='javascript:;' class='btn btn-" + (value ? "info" : "default") + " btn-xs' >" + (value ? __('Yes') : __('No')) + "</a>";
                },
